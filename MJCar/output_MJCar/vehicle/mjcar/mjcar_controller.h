...
class MjcarController final : public VehicleController {
 public:

  explicit MjcarController() {};

  virtual ~MjcarController();
 ...
 private:
  // control protocol
  Brakecommand101101* brakecommand101_101_ = nullptr;
  Gearcommand103103* gearcommand103_103_ = nullptr;
  Steeringcommand102102* steeringcommand102_102_ = nullptr;
  Throttlecommand100100* throttlecommand100_100_ = nullptr;
