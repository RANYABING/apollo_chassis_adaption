...
void Steeringreport502502::Parse(const std::uint8_t* bytes, int32_t length,
  ...
  chassis->mutable_MJCar()->mutable_steeringreport502_502()->set_handwheelsteerangspdact(handwheelsteerangspdact(bytes, length));
  chassis->mutable_MJCar()->mutable_steeringreport502_502()->set_handwheelsteerangact(handwheelsteerangact(bytes, length));
  chassis->mutable_MJCar()->mutable_steeringreport502_502()->set_steercomfault(steercomfault(bytes, length));
  chassis->mutable_MJCar()->mutable_steeringreport502_502()->set_steerhardfault(steerhardfault(bytes, length));
  chassis->mutable_MJCar()->mutable_steeringreport502_502()->set_steerenstate(steerenstate(bytes, length));
}
